...
// Having a large amount of event handlers on a page impacts performance 
...
// EVENT CONSTRUCTOR
  ...
  // options - is a object with two optional properties:
    // bubbles: a boolean value that determines if the event bubbles or not
    // cancelable: also a boolean that specifies whether the event is cancelable

  // by default the options object is:
    // {bubbles: false, cancelable: false}

    // The following creates a new click event with the default options object:
      // let clickEvent = new Event("click");
    
  // dispatchEvent method
    // after creating an event, you can fire it on a target element using 
    ...
    // In the example the event handler is executed as if the click event were generated by user actions.

// -------------------- JAVASCRIPT CUSTOM EVENTS --------------------

// Standard events are provided that you can listen to such as click, input, and submit
// The browser automatically triggers these events when something happens like mouse clicks or document loading.

// custom events are you events you define and dispatch yourself.
...
// CREATING JAVASCRIPT CUSTOM EVENTS
  // To create a custom event you use the CustomEvent() constructor:
    // It has two parameters:
      // eventType: A string that represents the name of the event.
      // options: A object which has the detail property that contains any custom information.
  
  // CustomEvent inherits form the regular Event object and adds the detail property for passing custom data.
...
// DISPATCHING JAVASCRIPT CUSTOM EVENTS
  // After creating a custom event, attach the event to a DOM element and trigger it by using dispatchEvent()
